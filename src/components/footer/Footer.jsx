  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-black pt-1 text-white flex justify-around items-center lg:h-1/4 sm:h-1/5">
        ...
        <div className='flex font-mono flex-col justify-center'>
            <h2 style={{marginBottom:'8%'}} className="text-xs md:text-base lg:text-lg">Contact Details</h2>

            <p className="text-xs md:text-xs lg:text-lg">Hotline -{Number_one} </p>
            <p className="text-xs md:text-xs lg:text-lg">Hotline -{Number_two} </p>
